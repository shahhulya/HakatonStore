    ...
    <MainLayout>
      {productDetail ? (
        <div className={classes.container}>
          ...
          <Typography variant="h5">What to see: {productDetail.title}</Typography>
          <Typography variant="h5">Location: {productDetail.location}</Typography>
          <Typography variant="h5">Area: {productDetail.area}</Typography>
          <Typography variant="h5">Established: {productDetail.established} </Typography>
